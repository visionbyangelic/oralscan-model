...
st.set_page_config(page_title="OralScan AI", page_icon="🦷", layout="centered")
...
if uploaded:
    ...
    st.warning("⚠️ For screening purposes only. Consult a qualified clinician for diagnosis.")
